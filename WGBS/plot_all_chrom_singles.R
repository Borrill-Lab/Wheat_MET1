...
for(i in 1:21){
  ...
  aaBBDD <- readBismark(paste("Unknown_BU703-001Z0002_1.",chromosome,".CX_report.txt", sep=""))
  AAbbDD <- readBismark(paste("Unknown_BU703-001Z0003_1.",chromosome,".CX_report.txt", sep=""))
  AABBdd <- readBismark(paste("Unknown_BU703-001Z0004_1.",chromosome,".CX_report.txt", sep=""))
  ...
  setwd("/jic/scratch/groups/Philippa-Borrill/Delfi/MET1_WGBS/filter_by_chrom/chr_plots_singles/")
