...
#
# Aim of script is to run fastp for multiple samples of WGBS data

#### paths and references:
my $read_path_triticum = "/jic/scratch/groups/Philippa-Borrill/Delfi/MET1_WGBS/";
my $output_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/MET1_WGBS/trim/";
...
my $input_list_dir = "/jic/scratch/groups/Philippa-Borrill/Delfi/MET1_WGBS/";
my $input_for_trim = "/jic/scratch/groups/Philippa-Borrill/Delfi/MET1_WGBS/list_of_samples.txt";
...
#SBATCH -J trim
#SBATCH -o /jic/scratch/groups/Philippa-Borrill/Delfi/MET1_WGBS/trim/slurm_output/%x.%N.%j.out
#SBATCH -e /jic/scratch/groups/Philippa-Borrill/Delfi/MET1_WGBS/trim/slurm_output/%x.%N.%j.err
SLURM
